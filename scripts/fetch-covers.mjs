/**
 * Optional helper: fetches missing book cover images from Open Library.
 * Covers are saved to library/covers/{slug}.jpg. Not required for the
 * Library to work — run manually after adding a book with no cover art.
 *
 *   cd scripts && npm install && node fetch-covers.mjs
 */
...
const BOOKS_FILE = join(ROOT, 'library', 'books.yaml');
const DELAY_MS = 400;
